...
function Navbar() {
  ...
  return (
    <>
      <nav
        className={`${
          isSticky ? "fixed top-0 z-20 bg-white w-full " : ""
        }  border-2 border-slate-100 py-3 px-4 
      rounded-md shadow-lg flex items-center justify-between mb-10 max-w-screen-xl mx-auto`}
      >
        <NavLink
          to="/"
            ...
            >
              ...
              <li className="cursor-pointer hover:bg-blue-500 hover:text-white rounded-md py-2 px-3">
                <NavLink
                  ...
                  className="hover:text-white rounded-md py-2 px-3"
                >
                  Login
                </NavLink>
              </li>
